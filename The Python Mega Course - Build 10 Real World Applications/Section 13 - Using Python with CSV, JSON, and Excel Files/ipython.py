...
In [6]: df1 = pandas.DataFrame([[2,4,6],[10,20,30]],columns=["Price","Age","Value"],index=["1st","2nd"])
...
In [10]: df2=pandas.DataFrame([{"Name":"John", "Surname":"John"},{"Name":"Jack", "Surname":"Jacky"}])
